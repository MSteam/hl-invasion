...
*																		*
************************************************************************/
// menu vgui pour le contr�le de l ordinateur
...
#define BOUTON_DONNEESSYSTEME	"Donn�es syst�me"
#define BOUTON_SECURITE			"S�curit�"

#define ENTREE_TEXT		"Entrer"
#define TITLE_TEXT		"R�seau informatique interne de Black Mesa"
#define INTRO_TEXT		"Terminal n� 622 - 431 - 018\nSecteur L-G12\n\nL'acces aux donn�es de ce syst�me est\nstrictement r�serv� au personnel accr�dit�.\n\nToute utilisation non-autoris�e donnera lieu\n� un renvoi imm�diat et sera \ns�v�rement punie.\n\n\nVotre code ECA peut vous �tre demand�.\nIl figure sur votre autorisation d'utilisation � retirer\nau bureau du personnel, secteur A niveau 5.\n\nLa direction du centre de recherches de Black Mesa\nne peut en aucun cas �tre tenue pour responsable\nde la perte de ce code."	
...
#define MESSAGE_TEXTE2	"============================================================\n================   MESSAGERIE   ===================\n\nMessage de :\n        VAN BUREN, Docteur\n\nNum�ro de message :\n        36682929L-220614M\n\n\n	Je vous addresse ce courrier pour vous prier\nde bien vouloir vous rendre au plus vite dans mon bureau.\nJ'ai des r�v�lations importantes � vous faire\nconcernant l'activit� des militaires.\nCeux-ci ont des raisons de croire que la menace extraterrestre\nn'est pas encore �cart�e ; cela pourrait nous causer\nde graves ennuis.\n"
#define MESSAGE_TEXTE3	"============================================================\n================   MESSAGERIE   ===================\n\nMessage de :\n        HARRINGTON, Professeur\n\nNum�ro de message :\n        20020451S-511322T\n\n\n	Je viens de saisir les propos de deux militaires\nil y a quelques instants � peine.\nCeux ci sont dans un �tat de grande agitation : des signes\nd'activit� d'origine extraterrestre ont �t� d�tect�s en profondeur\ndu secteur principal de BlackMesa.\nLes militaires pensaient avoir d�finitivement �limin� la menace\nennemie avec la destruction du nihilant ; il apparait qu'ils\ndoivent toujours poss�der un �chantillon de ce min�ral\npermettant la t�l�portation.\n"
#define MESSAGE_TEXTE4	"============================================================\n================   MESSAGERIE   ===================\n\nMessage de :\n        NEWEL, Professeur\n\nNum�ro de message :\n        50235548D-459635F\n\n\n	Cher coll�gue,\nJe ne supporte pas la pr�sence de ces cam�ras dans tout\nle b�timent ; les militaires ont r�cemment r�tabli\n� leur profit ces engins dans les couloirs.\nJ'ai pirat� le syst�me de s�curit�, que ces imb�ciles ont reli�\nau r�seau informatique. Les cam�ras peuvent �tre d�sactiv�es\n� l'aide d'un code mais je ne sais pas encore � partir de\nquel ordinateur.\n\n\nIl s'agit d'un code � quatre chiffres :\nle     7-6-0-2\nAvertissez moi si vous avez du nouveau sur cette affaire.\n"

//#define MESSAGE_TEXTE1	"============================================================\n================   MESSAGERIE   ===================\n\nMessage de :\n        JOHNSON, Docteur\n\nNum�ro de message :\n        54995115S-852147H\n\n\n	MESSAGE A L INTENTION DE M.FREEMAN\n\nFreeman, je vois que mon coll�gue vous a dit que\nje souhaitais vous rencontrer. Malheureusement je crains\nde vous avoir attir� malgr� moi dans un pi�ge.\nLes militaires ont un moment tol�r� la pr�sence des scientifiques\ndans le b�timent central de Black Mesa, o� vous\nvous trouvez actuellement ; cependant depuis qu'ils ont\nd�tect� de nouveaux signaux extraterrestres ils ont\nproc�d� � l'�vacuation de la base. Mes coll�gues et moi avons\ndu fuir avant de pouvoir entrer en contact avec vous.\nJe vous attends toujours dans un �tage inf�rieur du b�timent.\n\nVous pouvez d�sactiver les cam�ras de s�curit� depuis cet\nordinateur, mais il vous faudra le code. Un de mes coll�gues\nl'a d�couvert : vous le trouverez sur un ordinateur\npersonnel dans un des bureaux de cet �tage.\n"
#define MESSAGE_TEXTE1	GetOrdiText ( "MESSAGE_TEXTE1" )

#define INFO_TEXTE1		"============================================================\n================   INFORMATIONS   ===================\n\n Destin�es � tout le personnel\n\n     Note n�54231 :\n A partir de la semaine prochaine, les locaux\nde l'aile B-85A du b�timent seront utilis�s\n par l'�quipe alpha 21.\n\nEn raison de l'extr�me confidentialit� des recherches\neffectu�es, toute circulation de personne �trang�re au service\n sera formellement interdite.\n\n"
#define INFO_TEXTE2		"============================================================\n================   INFORMATIONS   ===================\n\n Destin�es � tout le personnel\n\n     Note n�54232 :\n Suite � un usage intempestif et violent de la part de\ncertains employ�s, le distributeur de boissons de\nl'�tage B-791FG est momentan�ment hors-service.\nLa Direction signale que ce distributeur est la\npropri�t� de tous les employ�s et qu'ils\ndoivent en prendre soin.\n"

#define REFUSE_TEXTE	"============================================================\n================   AVERTSSEMENT   ===================\n\nVOUS N'ETES PAS AUTORISE\n A ACCEDER A CES INFORMATIONS"
#define KEYPAD_TEXTE	"============================================================\n================     SECURITE     ===================\n\nLa modification de tout param�tre\nrelatif � la s�curit� du b�timent est strictement r�serv�e\nau personnel accr�dit�.\nSi en cas d'extr�me urgence il �tait n�cessaire\nde d�sactiver les cam�ras de s�curit�,\nveuillez entrer votre code ECA ci dessous."
#define KEYPAD_TEXTE2	"============================================================\n================     SECURITE     ===================\n\n\n\n\nCameras de securit� desactiv�es !"
*/
...
COrdiMenuPanel :: COrdiMenuPanel(int iTrans, int iRemoveMe, int x,int y,int wide,int tall) : CMenuPanel(iTrans, iRemoveMe, x,y,wide,tall)
{
	...
	//fonction appel�e a chaque chargement de niveau
...
void CMenuHandler_OrdiMenu :: actionPerformed(Panel* panel)		// fonction declenchee lors de l'appui sur un boutton
{
	...
	else if ( m_iType == HANDLER_KEYPAD )
	{
		...
		// d�cale les chiffres d'une place
...
//	char messagename [62];
	std::sprintf ( messagename, textname );
	...
	std::sprintf ( source, messagetext );
	std::sprintf ( dest, "" );

	int i;

	for ( i=0; i<(int)std::strlen(source); i++ )
	{
		if ( source[i] != '\n' )
			break;
	}
	...
	for ( i=i; i<(int)std::strlen(source); i++ )
	{
		if (source[i] == '\0' )
			continue;
		...
		if (source[i] != ' ' && source[i] != '\n' )
		{
			while ( source[i+lettres] != ' ' )
			{
				...
				char caractere [2];
				std::sprintf ( caractere, "%c", source[i+lettres] );
...
//			curseurY += gHUD.m_scrinfo.iCharHeight;
		...
		for ( int j=0; j<lettres; j++ )
		{
			...
			std::sprintf ( cat, "%c", source[i+j] );

			std::strcat ( dest, cat );


			char caractere [2];
			std::sprintf ( caractere, "%c", source[i+j] );
			int len = 0;
			pRadioFont->getTextSize ( caractere, len, rien );
